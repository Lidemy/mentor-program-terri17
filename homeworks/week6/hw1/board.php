...
<html>
	...
	<body>
		<div class=log>
			<div>您登入的帳號為：<?php echo $_COOKIE["username"]; ?></div>
...
<?php   
	...
	$nic = "SELECT * FROM terri_week5hw3 where username=".$_COOKIE["username"];  
...
<?php		if ($_COOKIE['username']===$row["nickname"]){					
...
<?php
			if ($_COOKIE['username']===$row_child["nickname"]){
